...
return array(
    /**
     * Login Throttle
     * Defines how many login failed tries may be done within two minutes.
     */
    'throttle_limit' => 9,

    /**
     * Form Views
     * The VIEWS used to render forms with Confide methods: makeLoginForm,
     * makeSignupForm, makeForgotPasswordForm, and makeResetPasswordForm.
     * By default, the out of the box confide views are used but you can create
     * your own forms and replace the view names here. For example, to use
     * app/views/user/signup.blade.php:
     ...
     * By default, the out of the box confide views are used but you can create
     * your own forms and replace the view names here. For example, to use
     * app/views/email/confirmation.blade.php:
     * 'email_account_confirmation' => 'email.confirmation'
     */
    'email_reset_password' =>       'confide::emails.passwordreset',
    'email_account_confirmation' => 'confide::emails.confirm',

    /**
     * Signup (create) Cache
     * By default you will only can only register once every 2 hours (120
     * minutes) because you are not able to receive a registration email more
     * often then that.

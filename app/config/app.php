...
return array(
     ...
     * will be used by the PHP date and date-time functions. We have gone ahead
     ...
     * the translation service provider. You are free to set this value to any
     ...
     * Encryption Key
     *
     * This key is used by the Illuminate encrypter service and should be set to
     * a random, 32 character string, otherwise these encrypted strings will not
     ...
     * providers which are not needed for each request, as well to keep a list
     * of all of the services. Here, you may set its storage spot.
     */
